    ...
    <div className="bg-half-transparent w-screen fixed nav-item top-0 right-0">
      <div className="float-right h-screen dark:text-gray-200 bg-white dark:[#484B52] w-400 dark:bg-secondary-dark-bg">
        <div className="flex justify-between items-center p-4 ml-4">
          <p className="font-semibold text-xl dark:text-slate-200">Settings</p>
          <button type="button" onClick={() => setThemeSettings(false)}
          style={{color: 'rgb(153, 171, 180)', borderRadius: '50%'}}
          className="hover:drop-shadow-xl text-2xl p-3 hover:bg-light-gray"
          >
            <MdOutlineCancel />
          </button>
        </div>
        ...
        <div className="flex flex-col border-t-1 border-color p-4 ml-4">
          <p className="font-semibold text-lg dark:text-slate-200">Theme Options</p>
          <div className="mt-4">
            <input 
              type="radio"
              id="light"
