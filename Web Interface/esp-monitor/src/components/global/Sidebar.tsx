...
const Sidebar:FC<sidebarProps> = ({sideIsOpen}) => {
  const activeLink = "outline-none flex items-center gap-2 bg-main-dark-bg hover:bg-main-dark-bg px-2 py-4 rounded-lg text-lg transition-all duration-100 ease-in-out"
  const normalLink = "outline-none flex items-center gap-2 hover:bg-main-dark-bg px-2 py-4 rounded-lg text-lg transition-all duration-100 ease-in-out"
